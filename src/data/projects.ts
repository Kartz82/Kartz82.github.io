    ...
    metrics: [
      {
        label: "Order volume",
        value: "3,421,083",
        context: "total orders analyzed",
        verified: true,
      },
      {
        label: "Customers",
        value: "206,209",
        context: "total customers analyzed",
        verified: true,
      },
      {
        label: "Products",
        value: "49,688",
        context: "product SKU catalog size",
        verified: true,
      },
      {
        label: "Largest segment",
        value: "69,635",
        context: "Moderate Engagement customers",
        verified: true,
      },
    ],
    links: [
    ...
    metrics: [
      {
        ...
        value: "5,878",
        context: "RFM-scored customers",
        verified: true,
      },
      {
        label: "Transactions",
        value: "805,549",
        context: "cleaned retail transactions",
        verified: true,
      },
      {
        label: "Champion revenue",
        value: "68.12%",
        context: "historical revenue concentration",
        verified: true,
      },
      {
        label: "High-value risk",
        value: "89",
        context: "customers flagged at risk",
        verified: true,
      },
    ],
    links: [
